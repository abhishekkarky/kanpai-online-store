package com.system.kanpaionlinestore.security;

import com.system.kanpaionlinestore.config.PasswordEncoderUtil;
import com.system.kanpaionlinestore.service.impl.CustomUserDetailService;
...
public class SpringSecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws  Exception{
        httpSecurity.csrf().disable()
                ...
                .requestMatchers("/landing/**","/user/**","/product/**","/cart/**","/contact/**")
                .permitAll()
